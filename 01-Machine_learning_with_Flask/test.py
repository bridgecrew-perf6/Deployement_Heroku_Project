...
ENDPOINT = "http://127.0.0.1:5002/predict"

test_ok = requests.post(ENDPOINT, json={"year": 15})
print(test_ok, test_ok.json())

#test_ok_rounded = requests.post(ENDPOINT, json={"year": 5, "rounded": "True", "bonjour": "Céline"})
